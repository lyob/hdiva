...
class DiVA_ConvNet_dSprites_Training_Config(
    ...
    timestep_dist: str = "linear_then_uniform"
    num_kernels: int = 48
    ...
    data_cache_dir: str = f"{project_dir}/a_datasets/dsprites"  # Note: original had no trailing slash for ConvNet, but had it for Manual. Keeping exact match.
