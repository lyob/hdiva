...
class DiVA(DDPM):
    ...
    def compute_score(self, log_p_z, noisy_x):
        ...
        rec_score = torch.autograd.grad(
            log_p_z, noisy_x, torch.ones_like(log_p_z), retain_graph=True, create_graph=True
        )[0]
        return rec_score
    ...
    def compute_loss(self, clean_x, kl_weight: float = 1.0):
